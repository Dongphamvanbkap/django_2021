...
def home_view(request):
    ...
    if request.method == 'POST':
        ...
        if len(sales_qs) > 0:
            ...
            sales_df['created'] = sales_df['created'].apply(lambda date: date.strftime('%d-%m-%Y'))
            sales_df.rename({'customer_id': 'customner', 'salesman_id': 'salesman', 'id': 'sales_id'}, axis=1, inplace=True)
            ...
            no_data = 'No data is available in this datr range!'
